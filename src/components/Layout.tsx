...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconPackage, IconSettings, IconShoppingCart, IconTag } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';
import ActionsBar from '@/components/ActionsBar';

const APP_TITLE = 'Marktplatz';
...
const navigation = [
  ...
  { name: 'Kategorien', href: '/kategorien', icon: IconTag },
  { name: 'Bestellungen', href: '/bestellungen', icon: IconShoppingCart },
  { name: 'Verkäufer', href: '/verkaeufer', icon: IconFileText },
  { name: 'Produkte', href: '/produkte', icon: IconPackage },
];

const externalNavigation = [
  { name: 'Kategorien', href: '/gateway/apps/699f4a00aec743a67b58a7ce?template=list_page', icon: IconTag },
  { name: 'Bestellungen', href: '/gateway/apps/699f4a083f72e014fbc6f8ea?template=list_page', icon: IconShoppingCart },
  { name: 'Verkäufer', href: '/gateway/apps/699f4a06f429752b6030c846?template=list_page', icon: IconFileText },
  { name: 'Produkte', href: '/gateway/apps/699f4a0798760968fa3378a6?template=list_page', icon: IconPackage },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/699f4a00aec743a67b58a7ce?template=list_page"
