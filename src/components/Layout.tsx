...
import { FileText, LayoutDashboard, Menu, Package, ShoppingCart, Tag, X } from 'lucide-react';
import { useState } from 'react';
import ChatWidget from '@/components/ChatWidget';

// ⚡ Customize these for your app
const APP_TITLE = 'Marktplatz';
const APP_SUBTITLE = 'Bestellverwaltung';

const navigation = [
  { name: 'Übersicht', href: '/', icon: LayoutDashboard },
  { name: 'Kategorien', href: '/kategorien', icon: Tag },
  { name: 'Verkäufer', href: '/verkaeufer', icon: FileText },
        ...
        <div className="flex items-center justify-between px-5 py-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-sidebar-primary flex items-center justify-center shadow-sm">
              <Tag size={16} className="text-sidebar-primary-foreground" />
            </div>
            <div>
