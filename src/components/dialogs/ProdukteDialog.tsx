...
export function ProdukteDialog({ open, onClose, onSubmit, defaultValues, kategorienList, verkaeuferList, enablePhotoScan = true, enablePhotoLocation = true }: ProdukteDialogProps) {
