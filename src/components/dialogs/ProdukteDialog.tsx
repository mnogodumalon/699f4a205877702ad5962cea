...
export function ProdukteDialog({ open, onClose, onSubmit, defaultValues, kategorienList, verkaeuferList, enablePhotoScan = false, enablePhotoLocation = true }: ProdukteDialogProps) {
