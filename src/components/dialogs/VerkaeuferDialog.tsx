...
export function VerkaeuferDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false }: VerkaeuferDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await onSubmit(fields as Verkaeufer['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      const schema = `{\n  "firma_name": string | null, // Firmenname / Verkäufername\n  "kontakt_vorname": string | null, // Vorname Ansprechpartner\n  "kontakt_nachname": string | null, // Nachname Ansprechpartner\n  "email": string | null, // E-Mail-Adresse\n  "telefon": string | null, // Telefonnummer\n  "strasse": string | null, // Straße\n  "hausnummer": string | null, // Hausnummer\n  "postleitzahl": string | null, // Postleitzahl\n  "stadt": string | null, // Stadt\n  "beschreibung": string | null, // Beschreibung / Über uns\n}`;
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{defaultValues ? 'Verkäufer bearbeiten' : 'Verkäufer hinzufügen'}</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="firma_name">Firmenname / Verkäufername</Label>
            <Input
              id="firma_name"
          ...
          <div className="space-y-2">
            <Label htmlFor="kontakt_vorname">Vorname Ansprechpartner</Label>
            <Input
              id="kontakt_vorname"
          ...
          <div className="space-y-2">
            <Label htmlFor="kontakt_nachname">Nachname Ansprechpartner</Label>
            <Input
              id="kontakt_nachname"
          ...
          <div className="space-y-2">
            <Label htmlFor="beschreibung">Beschreibung / Über uns</Label>
            <Textarea
              id="beschreibung"
