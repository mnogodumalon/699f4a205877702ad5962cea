...
export function BestellungenDialog({ open, onClose, onSubmit, defaultValues, produkteList, enablePhotoScan = true, enablePhotoLocation = true }: BestellungenDialogProps) {
