...
export function BestellungenDialog({ open, onClose, onSubmit, defaultValues, produkteList, enablePhotoScan = false, enablePhotoLocation = true }: BestellungenDialogProps) {
