...
const VERKAEUFER_FIELDS = [
  { key: 'firma_name', label: 'Firmenname / Verkäufername', type: 'string/text' },
  { key: 'kontakt_vorname', label: 'Vorname Ansprechpartner', type: 'string/text' },
  { key: 'kontakt_nachname', label: 'Nachname Ansprechpartner', type: 'string/text' },
  ...
  { key: 'beschreibung', label: 'Beschreibung / Über uns', type: 'string/textarea' },
];
const BESTELLUNGEN_FIELDS = [
  { key: 'produkte', label: 'Produkte', type: 'applookup/select', targetEntity: 'produkte', targetAppId: 'PRODUKTE', displayField: 'produkt_name' },
  { key: 'kaeufer_vorname', label: 'Vorname', type: 'string/text' },
  { key: 'kaeufer_nachname', label: 'Nachname', type: 'string/text' },
  { key: 'kaeufer_email', label: 'E-Mail-Adresse', type: 'string/email' },
  { key: 'kaeufer_telefon', label: 'Telefonnummer', type: 'string/tel' },
  { key: 'liefer_strasse', label: 'Straße', type: 'string/text' },
  { key: 'liefer_hausnummer', label: 'Hausnummer', type: 'string/text' },
  { key: 'liefer_postleitzahl', label: 'Postleitzahl', type: 'string/text' },
  { key: 'liefer_stadt', label: 'Stadt', type: 'string/text' },
  { key: 'bestelldatum', label: 'Bestelldatum', type: 'date/date' },
  { key: 'gesamtbetrag', label: 'Gesamtbetrag (in Euro)', type: 'number' },
  { key: 'bestellstatus', label: 'Bestellstatus', type: 'lookup/select', options: [{ key: 'neu', label: 'Neu' }, { key: 'in_bearbeitung', label: 'In Bearbeitung' }, { key: 'versendet', label: 'Versendet' }, { key: 'zugestellt', label: 'Zugestellt' }, { key: 'storniert', label: 'Storniert' }] },
];
...
const PRODUKTE_FIELDS = [
  ...
  { key: 'produkt_beschreibung', label: 'Produktbeschreibung', type: 'string/textarea' },
  ...
  { key: 'verkaeufer', label: 'Verkäufer', type: 'applookup/select', targetEntity: 'verkaeufer', targetAppId: 'VERKAEUFER', displayField: 'firma_name' },
  { key: 'verfuegbar', label: 'Verfügbar', type: 'bool' },
  { key: 'produktbilder', label: 'Produktbilder', type: 'file' },
];
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<EntityKey>('verkaeufer');
